...
- **Description:** Backend API endpoint URL (HTTPS required for production)
- **Environment:** Production, Preview, Development

### 2. `VITE_WS_URL`
- **Value:** `wss://api.cascade-erp.in/ws`
- **Description:** WebSocket connection URL (WSS required for production)
- **Environment:** Production, Preview, Development
...
- The backend API will be accessible at `https://api.cascade-erp.in`
